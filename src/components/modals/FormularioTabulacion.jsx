    ...
    <FormularioTabulacionSkeleton />
                ...
                <>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-3.5 rounded-md">
                    ...
                    <section className={cardStyle}>
                      ...
                      <div className="grid grid-cols-2 gap-x-3 gap-y-3.5 content-start flex-1">
                    ...
                    <section className={cardStyle}>
                      <HeaderSection
                        ...
                        bgColor="bg-red-50"
                      />
                      <div className="space-y-3.5 flex-1 justify-start flex flex-col">
                        <SelectField
                        ...
                        >
                          <p
                            className="text-[11.5px] font-medium tracking-wider uppercase"
            ...
            <div className="flex justify-end gap-4 px-5 sm:px-6 py-4 border-t border-slate-200 bg-slate-50 shrink-0">
              <button
                ...
                className="px-4 py-3 rounded-lg font-medium text-[11.5px] border uppercase border-slate-300 text-slate-500 bg-slate-100 hover:bg-slate-200 transition-colors tracking-wider disabled:opacity-50 disabled:cursor-not-allowed"
              >
